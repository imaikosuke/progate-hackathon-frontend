...
const data = [
  ...
  { number: 4, address: '浅草文化観光センター', lat: 35.711742, lng: 139.796574 },
...
const RootList: React.FC<RootListProps> = ({ onSelectLocation }) => {
  return (
    <div className="p-4">
      <h2 className="text-xl font-semibold">ルート一覧</h2>
      <RootListItems items={data} onSelectLocation={onSelectLocation} />
    </div>
  );
};
